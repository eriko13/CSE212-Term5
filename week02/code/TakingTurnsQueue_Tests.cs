...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected Bob but got Sue on first call - indicates queue is not FIFO, likely behaving as LIFO/stack instead
    ...
    // Defect(s) Found: Expected Bob but got Sue on first call - same FIFO issue as above
    ...
    // Defect(s) Found: Expected Tim but got Sue on first call - same FIFO issue as above
